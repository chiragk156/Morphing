...
vector<Point2f> readPoints(string pointsFileName)
{
    ...
    ifstream ifs;
    if(pointsFileName=="hillary_clinton.jpg.txt") ifs.open("hillary_clinton.jpg.txt");
    if(pointsFileName=="ted_cruz.jpg.txt") ifs.open("ted_cruz.jpg.txt");
    float x, y;
    while(ifs >> x >> y)
    {
...
int main( int argc, char** argv)
{
    ...
    //Read points
    vector<Point2f> points1 = readPoints("hillary_clinton.jpg.txt");
    vector<Point2f> points2 = readPoints("ted_cruz.jpg.txt");
    vector<Point2f> points;
